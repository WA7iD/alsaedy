      ...
      <div className='container '>
        <div className='flex flex-row justify-between items-center gap-10 bg-primary rounded-[50px]  p-10 overflow-hidden relative h-[500px]'>
          ...
          <img
            ...
            className='absolute top-0 left-0 w-full object-cover h-full '
          />
          <div className='flex-1 text-white flex  flex-col items-center text-center md:items-start md:text-right gap-4 z-10'>
            ...
            <div className='flex flex-col md:flex-row justify-start items-center gap-4 mt-5'>
